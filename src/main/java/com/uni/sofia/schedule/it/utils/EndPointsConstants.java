package com.uni.sofia.schedule.it.utils;


public class EndPointsConstants {
    public static final String USERS_CONTROLLER_ENDPOINT = "/api/users";
    public static final String REGISTER_ENDPOINT = "/sign-up";
    public static final String GET_ALL_USERS_ENDPOINT = "/all-users";
